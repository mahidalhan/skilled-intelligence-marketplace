...
# Displays: directory | model | context usage | git info | cost
#
# Setup:
# 1. Copy this script to ~/.claude/statusline.sh
# 2. Make it executable: chmod +x ~/.claude/statusline.sh
# 3. Configure Claude Code: claude config set status_line.command ~/.claude/statusline.sh
#
...
# DEBUG: Uncomment to debug input
